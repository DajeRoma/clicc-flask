...
environment_code = environment_worksheet.col_values(1, start_rowx=1,end_rowx=None)
environment_value = environment_worksheet.col_values(2, start_rowx=1,end_rowx=None)
