Running SikuliX-based Scripts(Windows 7)
What you need:
**NOW USING ANACONDA INSTALLATION PACKAGE FOR PYTHON AND PYTHON MODULES**
once anaconda is installed, you only need to pip install * where * is any
package the server says it cant find, notably pybrain and chemspipy.
			Python 2.7-
