...
class PipeOut:
    ...
    def send(self, message):
        while 1:
            hPipe = windll.kernel32.CreateFileA(self.szPipename, GENERIC_READ | GENERIC_WRITE, 0, None, OPEN_EXISTING, 0, None)
            ...
            if (windll.kernel32.GetLastError() != ERROR_PIPE_BUSY):
                ...
                return
            elif ((windll.kernel32.WaitNamedPipeA(self.szPipename, 20000)) == 0):
                print "Could not open pipe\n"
                return
